...
static u16 LZ4_readLE16(const void *src) { return le16_to_cpu(get_unaligned((u16 *)src)); }
static void LZ4_copy4(void *dst, const void *src) { put_unaligned(get_unaligned((u32 *) src), (u32 *) dst);}
static void LZ4_copy8(void *dst, const void *src) { put_unaligned(get_unaligned((u64 *) src), (u64 *) dst);}
