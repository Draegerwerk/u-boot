 ...
 * which performed OK. The set in ram_calibration_mx6q_06 is used for these old boards.
...
/* The set in ram_calibration_mx6q_08 is used for the boards beginning with revision index 8. The parameters have been
